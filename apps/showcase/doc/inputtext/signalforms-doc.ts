    ...
    template: `
        ...
        <app-demo-wrapper>
            <div class="flex justify-center">
                <form (ngSubmit)="onSubmit()" class="flex flex-col gap-4 w-full sm:w-56">
                    <div class="flex flex-col gap-1">
                        <input pInputText type="text" id="username" placeholder="Username" [formField]="exampleForm.username" [invalid]="isInvalid(exampleForm.username)" />
                    ...
                    <div class="flex flex-col gap-1">
                        <input pInputText type="email" id="email" placeholder="Email" [formField]="exampleForm.email" [invalid]="isInvalid(exampleForm.email)" />
